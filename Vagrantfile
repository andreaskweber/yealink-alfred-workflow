...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define "core" do |core|
        core.vm.host_name = "yealink.andreas-weber.dev"
        core.vm.network "private_network", ip: "192.161.96.83"

        core.vm.provider :virtualbox do |virtualbox|
            virtualbox.customize ["modifyvm", :id, "--name", "yealink-workflow.andreas-weber.dev"]
        end
    end
